...
<body style="font-family: 'Inter', sans-serif;" class="text-black bg-[#F0FBFF] ">
  ...
  <header class="shadow-lg relative bg-white">
    <div class="flex justify-between items-center max-w-screen-2xl mx-auto h-24 px-4">
      <div>
        <img src="./images/paytm_logo.png" alt="paytm logo" class="w-[11.25rem]">
      </div>
      <nav class="">
        <ul class="lg:flex gap-8 font-bold text-[1.0625rem] hidden">
          <li><a href="#" class="hover:bg-gray-100 p-3 rounded transition-all">Paytm for Consumer</a></li>
          <li><a href="#" class="hover:bg-gray-100 p-3 rounded transition-all">Paytm For Business</a></li>
      ...
      <div
        class="sign-in-btn bg-sky-500 text-white font-bold text-sm p-0.5 pl-5 rounded-full hover:bg-[#012970] cursor-pointer transition-all">
  ...
  <main class="bg-white">
    ...
    <section class="text-center sm:flex justify-center items-center gap-1 py-3 bg-gray-100">
      ...
      <span class="font-medium">to pay using UPI on Paytm.</span>
    ...
    <section class="mt-32">
      <div class="flex flex-col-reverse items-center sm:flex-row sm:justify-between max-w-screen-2xl mx-auto px-4">
        ...
        <div class="flex flex-col	gap-12 max-w-2xl pt-10 sm:pt-0">
          <div><img src="./images/hero-section-logo.png" alt="paytm upi img" class="w-[5rem] shadow-md	rounded-xl">
          </div>
    ...
    <section class="bg-[#00BAF2] mt-20">
      <div class="max-w-screen-2xl mx-auto py-16 px-4">
        <h2 class="text-4xl font-bold text-white">Recharge & Pay Bills on Paytm.</h2>
        <div class="flex flex-wrap justify-start mt-6 text-white">
          <!-- card 01 -->
          <div
            class="py-4 pl-4 pr-3 mr-4 min-w-fit hover:bg-[#01AFE3] transition-all duration-500 rounded-lg cursor-pointer">
          ...
          <!-- card 02 -->
          <div
            class="py-4 pl-4 pr-3 mr-4 min-w-fit hover:bg-[#01AFE3] transition-all duration-500 rounded-lg cursor-pointer transition-all">
    ...
    <section class="bg-[#0F4A8A]">
      <div class="max-w-screen-2xl mx-auto py-16 px-4">
        <h2 class="text-4xl font-bold text-white">Book & Buy on Paytm.</h2>
        <div class="flex flex-wrap justify-start mt-6 text-white">
          <!-- card 01 -->
          <div
            class="py-4 pl-4 pr-3 mr-4 min-w-fit hover:bg-[#0C3E80] transition-all duration-500 rounded-lg cursor-pointer transition-all">
    ...
    <section class="bg-[#F5F7FA]">
      <div class="max-w-screen-xl mx-auto pt-32 px-4">
        <h1 class="text-5xl font-bold">Paytm Payment Instruments</h1>
          ...
          <div class="">
            <div>
              <div class="flex items-center gap-4 font-bold">
                <img src="./images/paytm-wallet.png" alt="paytm-wallet" class="w-24">
                <p>Paytm <br> Wallet</p>
              </div>
        ...
        <div class="flex flex-col-reverse sm:flex-row gap-12 p-12 bg-white sm:py-20 sm:pl-28 sm:pr-12 mt-12 rounded-xl">
          ...
          <div>
            <div>
              ...
              <p class="font-medium text-lg my-6">
                With Paytm Postpaid, your wishlist doesn't have to be on the wait list. Shop for the things you want
                today and pay for them next month.
              </p>
              <div>
                <button href="#"
                  class="learn-more-btn relative flex bg-[#002970] text-white font-semibold items-center justify-center gap-2 pr-12 pl-8 py-3 rounded-full hover:bg-[#00baf2]">
                  Learn More
    ...
    <section>
      <div class="max-w-screen-xl mx-auto pt-32 px-4">
        <h1 class="text-5xl font-bold">Financial Services by Paytm</h1>
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between mt-12 max-w-screen-xl mx-auto px-4">
          ...
          <div class="sm:w-[30rem] pt-12 sm:pt-0">
            ...
            <h2 class="text-[2.5rem] font-bold leading-tight my-12">Build Long-term Wealth & Achieve your
              Goals.</h2>
            <p class="text-xl font-medium mb-12">
              Investing on Paytm Money is transparent, low-cost and commission-free. Buy stocks & mutual funds that can
    ...
    <section>
      <div class="max-w-screen-xl mx-auto px-4">
        <h1 class="text-5xl font-bold pt-32">Business Services by Paytm</h1>

        <!-- Service 01 : Accept payments online with ease -->
        <div
          class="mt-8 sm:pl-20 sm:pt-16 sm:pb-20 flex flex-col-reverse sm:flex-row items-center sm:items-stretch py-12 sm:justify-between bg-[#F5F7FA] rounded-lg">
          <!-- left side -->
        ...
        <div
          ...
          <!-- left side -->
          <div class="px-12 sm:w-[30rem] flex flex-col justify-center">
            <h2 class="text-4xl font-bold mt-12">In-shop payments powered by Paytm.</h2>
            <p class="py-7">
              Millions of small & big businesses use Paytm to accept payments anywhere any time with a wide range of
      ...
      <div class="max-w-screen-xl mx-auto pb-20 px-4">
        ...
        <div class="flex justify-center sm:justify-between flex-wrap gap-2">
          ...
          <div class="w-[15rem]">
            ...
            <h2 class="text-[1.625rem] font-bold pt-10 pb-5 leading-normal">Paytm for <br> Business App</h2>
            <p class="text-xl	font-medium pb-5">
          ...
          <div class="w-[15rem]">
            ...
            <h2 class="text-[1.625rem] font-bold pt-10 pb-5 leading-normal">Advertise on <br> Paytm</h2>
            <p class="text-xl	font-medium pb-5">
    ...
    <section class="bg-[#F0FBFF] py-16">
      ...
      <div class="flex justify-between flex-wrap max-w-screen-xl mx-auto sm:py-16 sm:pl-16  bg-white px-4 py-12">
        <div class="w-[12.5rem] flex flex-col justify-between">
          ...
          <a href="#" class="pt-5 font-bold text-[#66D6FF] hover:text-[#3fcafd] transition-all">Learn More</a>
        </div>

        <div class="flex justify-center flex-wrap gap-4 text-white font-bold pt-8 sm:pt:0">

          <!-- Card 01 -->
          <div class="w-[9.68rem] bg-[#66D6FF] p-1 flex flex-col items-center rounded  cursor-pointer">
      ...
      <div class="flex justify-between flex-wrap max-w-screen-xl mx-auto sm:py-16 sm:pl-16  bg-white px-4 pb-12">
        ...
        <div class="flex justify-center flex-wrap gap-4 text-white font-bold pt-8 sm: pt:0">
          ...
          <!-- Card 01 -->
          <div
            class="w-[9.68rem] bg-[#66D6FF] p-2 flex flex-col justify-center rounded hover:bg-[#3FC2ED] transition-all duration-500 cursor-pointer">
            <div class="w-[4.5rem]">
          ...
          <div
            ...
            <p class="text-xs">With Paytm's Cancellation Protect</p>
          </div>
